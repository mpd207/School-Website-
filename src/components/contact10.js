              ...
              {props.location1 ?? (
                <Fragment>
                  <h3 className="contact10-text20 thq-heading-3">
                    School Address: 123 Main Street, City, Country
                  </h3>
                </Fragment>
              )}
            </h3>
              ...
              {props.location1Description ?? (
                <Fragment>
                  <p className="contact10-text17 thq-body-large">
                    Visit us at the school campus for any in-person queries.
                  </p>
                </Fragment>
              )}
            </p>
              ...
              {props.location2Description ?? (
                <Fragment>
                  <p className="contact10-text19 thq-body-large">
                    Send us an email for any information or assistance.
                  </p>
                </Fragment>
              )}
            </p>
...
Contact10.defaultProps = {
  ...
  location1ImageAlt: 'School Building Image',
  location1: undefined,
  location2: undefined,
  rootClassName: '',
}
